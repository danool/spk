...
<body id="page-top" class="index">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="<?php echo site_url('welcome/')?>">Air Media Persada</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="<?php echo site_url('welcome/')?>">Contact</a>
                    </li>
                    <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Melayani dengan senang hati.</h3>
                </div>
            </div>
            <div class="row text-center">
                <div class="col-md-4">
                    ...
                    <p class="text-muted">Membuat website untuk keperluan perusahaan Anda. Di era digital website sangat dibutuhkan dalam berbagai hal untuk mengenalkan produk-produk perusahaan.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <p class="text-muted">Saat ini sebuah aplikasi sangat dibutuhkan perusahaan dalam mengatur berbagai aspek perusahaan. Rencanakan aplikasi yang tepat </p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <p class="text-muted">Keamanan untuk sebuah web atau bagaimana tata cara dari perusahaan anda untuk mengamankan suatu aplikasi yang dikelola.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Laporan lengkap berupa kumpulan dokumen atau informasi dari seseorang, kelompok, lembaga, organisasi, perusahaan atau sejenisnya yang bertujuan untuk mendokumentasikan perkembangan suatu proses dalam mencapai tujuan yang telah ditetapkan.</h3>
                </div>
            </div>
            <div class="row">
    ...
    <section id="about">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Tantang</h2>
                    <h3 class="section-subheading text-muted">Deskripsi singkat.</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <ul class="timeline">
                        <li>
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>2004-2017</h4>
                                    <h4 class="subheading">Tentang kita</h4>
                                </div>
                                <div class="timeline-body">
                                    <p class="text-muted">PT. Air Media Persada atau lebih dikenal dengan AirMedia adalah Perusahaan Software di Indonesia dengan Badan Hukum (Perseroan Terbatas) yang mengembangkan Sistem Informasi berbasis Web.</p>
                                </div>
                            </div>
                        </li>
                        <li class="timeline-inverted">
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>March 2011</h4>
                                    <h4 class="subheading">Produk</h4>
                                </div>
                                <div class="timeline-body">
                                    <p class="text-muted">Perancangan Sistem Informasi Akademik, Perpustakaan, Kepegawaian, Keuangan, Pengelolaan Aset, Portal Web/Web Desain, Pengadaan Hardware, Networking/Jaringan serta Pelatihan di bidang Teknologi Informasi.</p>
                                </div>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="timeline-panel">
                                ...
                                <div class="timeline-body">
                                    <p class="text-muted">Air Media Persada bertekad untuk menjadi sebuah Perusahaan Software dan Layanan Teknologi Informasi, dengan Kualifikasi dan Kompetensi Internasional, serta berorientasi Bisnis secara Profesional.
</p>
                                </div>
                            </div>
                        </li>
                        <li class="timeline-inverted">
                            ...
                            <div class="timeline-panel">
                                ...
                                <div class="timeline-body">
                                    <p class="text-muted">Mengembangkan Industri Teknologi Informasi dengan orientasi memasyarakatkan Penggunaan Teknologi Informasi, serta berorientasi Bisnis dan Pelayanan yang Profesional.
                                        Mengakomodasi Potensi Sumber Daya Manusia dan mengembangkan Peluang Bisnis dalam   bidang Teknologi Informasi yang ada.
                                        Memberikan Kontribusi bagi Perkembangan & Kemajuan Teknologi Informasi.</p>
                                </div>
                            </div>
                        </li>
                        <li class="timeline-inverted">
